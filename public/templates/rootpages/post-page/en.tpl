...
<div class="content-wrapper" style="padding-top: 1vh;">
	...
	<div class="news-container">
		...
		<article class="news-article">
			<p class=""><div class="imgV2"><img src="/public/images/gallery/img filler 5x7.jpg" alt="" width="100%"></div> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea dolorum eos excepturi
				...
				porro excepturi.</p>
				<p class=""><div class="imgV3"><img src="/public/images/gallery/img filler 7x5.jpg" alt="" width="100%"></div> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea dolorum eos excepturi
				repudiandae omnis quasi, adipisci ducimus ut officia iure quibusdam pariatur
				repellendus, ipsa unde vitae odio libero dolorem eligendi aspernatur hic quae. Quae
				neque voluptates blanditiis nemo aut ut a et quis hic. Accusamus, illum natus aperiam,
				magnam quasi tempora neque, cumque quo eligendi facilis fugit atque! Beatae quae
		...
		<div class="news-footer">
			<div class="news-page-keywords-wrapper">
				<a class="news-page-keyword">Новинки</a>
				<a class="news-page-keyword">Mariole life-style</a>
				<a class="news-page-keyword">Одежда</a>
			</div>
		</div>
	</div>
</div>
