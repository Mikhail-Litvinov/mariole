Styles: home;
Scripts: common/OJCarousel-min, unique/home;
Title: Главная;
<div id="carousel">
	...
	<div id="slide-container">
		...
		<div class="slide">
			...
			<div class="slide-btn-cont">
				<a navid="catalogue/accessories">
					<button class="slide-button">Для дома</button>
				</a>
			</div>
		</div>
	</div>
...
<div class="content-wrapper">
	<div class="section-wrapper-grid">
		<div class="grid-col-1-2-middle scrollable">
			<div class="relative-text-wrapper flex wrap flex-align-middle">
				<h2 class="content-text-h2">
					Надо придумать название этому
				</h2>
				...
				<a navid="catalogue/sale">
					<button class="content-button scrollable">Акции</button>
				</a>
				<a navid="catalogue/new">
					<button class="content-button scrollable">Новинки</button>
				</a>
			</div>
		</div>
