...
<div class="content-wrapper">
    <div class="cookies-content">
        <h2 class="title" clangid="cookie_use_policy"></h2>
        <p clangid="mariole_cookie_use_policy"></p>
        <p clangid="mariole_how_use"></p>
        <h2 clangid="cookie_term_definition"></h2>
        <p clangid="what_is_cookie"></p>
        <p clangid="what_cookie_contains"></p>
        <p clangid="what_cookie_for"></p>
        <p clangid="cookie_files_separates"></p>
        <ul>
            <li clangid="li_0_0"></li>
            <li clangid="li_0_1"></li>
        </ul>
        <h2 clangid="browser_term_definition"></h2>
        <p clangid="what_is_browser"></p>
        <p clangid="you_can"></p>
        <ul>
    ...
    <div class="confidential-content">
        <h2 class="title" clangid="privacy_policy"></h2>
        <p clangid="meaning"></p>
        <ul>
