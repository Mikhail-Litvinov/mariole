<head>
	<link rel="stylesheet" href="/public/css/content/catalogue.css">
	<link rel="stylesheet" href="/public/css/content/jquery.nselect.css">
</head>
<body>
...
<script>app.loadScripts(["common/jquery.nselect", "unique/catalogue"]);</script>